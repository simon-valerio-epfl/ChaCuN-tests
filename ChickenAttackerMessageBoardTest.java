...
class ChickenAttackerMessageBoardTest {
    @Test
    ...
    void messageBoardWithScoredForestWorksWithUnoccupiedForest() {
        var f1 = new Forest(10, Kind.PLAIN);
        var f2 = new Forest(20, Kind.PLAIN);
    ...
    void messageBoardWithScoredForestWorksWithOccupiedForest() {
        var f1 = new Forest(10, Kind.PLAIN);
        var f2 = new Forest(20, Kind.WITH_MUSHROOMS);
    ...
    void messageBoardWithClosedForestWithMenhirWorks() {
        var f1 = new Forest(10, Kind.PLAIN);
        var f2 = new Forest(20, Kind.WITH_MENHIR);
        var forestArea = new Area<>(Set.of(f1, f2), List.of(), 0);
        var mb = new MessageBoard(new BasicTextMaker(), List.of());
    ...
    void messageBoardWithScoredRiverWorksWithUnoccupiedRiver() {
        var r1 = new River(10, 1, null);
        var r2 = new River(20, 2, null);
    ...
    void messageBoardWithScoredHuntingTrapWorksWithUnworthyAnimals() {
        var m1 = new Meadow(10, List.of(new Animal(10_1, Animal.Kind.TIGER)), null);
        var m2 = new Meadow(20, List.of(new Animal(20_1, Animal.Kind.TIGER)), null);
        var m3 = new Meadow(30, List.of(), SpecialPower.HUNTING_TRAP);
        var meadowArea = new Area<>(Set.of(m1, m2, m3), List.of(RED), 0);
        var mb = new MessageBoard(new BasicTextMaker(), List.of());
        mb = mb.withScoredHuntingTrap(BLUE, meadowArea, Set.of());
        assertEquals(List.of(), mb.messages());
    }

    @Test
    void messageBoardWithScoredHuntingTrapWorksWithWorthyAnimals() {
        var m1 = new Meadow(10, List.of(new Animal(10_1, Animal.Kind.MAMMOTH)), null);
        var m2 = new Meadow(20, List.of(new Animal(20_1, Animal.Kind.AUROCHS)), null);
        var m3 = new Meadow(30, List.of(), SpecialPower.HUNTING_TRAP);
    ...
    void messageBoardWithScoredLogboatWorks() {
        ...
        var l2 = new Lake(28, 2, null);
        var r2 = new River(20, 5, l2);
        var r3 = new River(21, 5, l2);

        var l3 = new Lake(38, 3, null);
        var r4 = new River(30, 5, l3);
    ...
    void messageBoardWithScoredRiverSystemWorksWithFishlessRiverSystem() {
        var l1 = new Lake(18, 0, null);
        var r1 = new River(10, 0, l1);

        var l2 = new Lake(28, 0, null);
        var r2 = new River(20, 0, l2);
        var r3 = new River(21, 0, l2);

        var l3 = new Lake(38, 0, null);
        var r4 = new River(30, 0, l3);
    ...
    void messageBoardWithScoredRiverSystemWorks() {
        var l1 = new Lake(18, 3, null);
        var r1 = new River(10, 1, l1);

        var l2 = new Lake(28, 2, null);
        var r2 = new River(20, 1, l2);
        var r3 = new River(21, 1, l2);

        var l3 = new Lake(38, 3, null);
        var r4 = new River(30, 1, l3);
